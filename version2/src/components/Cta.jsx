...
const Cta = () => {
  ...
  return (
    <div className='text-white intro flex-col stats relative py-10 sm:py-16 md:py-20 justify-center items-center flex gap-6 sm:gap-9 px-4 sm:px-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12 my-12 sm:my-20 md:my-24 lg:my-33 px-0 sm:px-4 md:px-8 lg:px-20 w-full items-center'>
        <div onMouseEnter={() => {
          setHoverRole("User")
        }}
          onMouseLeave={() => {
        ...
        <div onMouseEnter={() => {
         ...
         className='flex transition-all hover:shadow-emerald-600/60 shadow-emerald-900 hover:shadow-xl hover:scale-105 md:hover:scale-112 justify-center gap-3 items-center flex-col p-5 sm:p-6 md:p-8 rounded-xl md:-translate-y-16 bg-white/5 backdrop-blur-sm'>
