...
const Navbar = () => {
  return (
    <nav className='flex bg-white/30 rounded-full mx-2 sm:mx-4 md:mx-auto w-auto md:w-full md:max-w-5xl items-center justify-between py-2 sm:py-3 px-3 sm:px-4 md:px-8 Nav shadow-xl gap-2 sm:gap-4 md:gap-10'>
    {/* 1. Logo Section */}
