...
const Navbar = () => {
  return (
    <nav className='flex bg-white/30 blood rounded-full mx-auto max-w-fit items-center justify-between py-3 px-4 sm:px-6 md:px-8 Nav shadow-xl gap-4 sm:gap-6 md:gap-10 flex-wrap sm:flex-nowrap'>
    {/* 1. Logo Section */}
