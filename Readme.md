...
This repository is the modern, full-stack evolution of that original idea — rebuilt from the ground up with React, Node/Express, MONGODB, and JWT auth, and scoped far beyond a CLI tool into a real multi-role platform meant to connect donors, patients, hospitals, and blood banks in real time .
